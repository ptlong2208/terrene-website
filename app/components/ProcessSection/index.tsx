...
export default function ProcessSection({ header, steps = [], cta }: ProcessSectionProps) {
  ...
  return (
    <section className="px-gutter grid min-h-svh grid-cols-[42%_1fr] items-start gap-[clamp(40px,6vw,100px)] py-[clamp(80px,10vh,140px)] max-lg:min-h-0 max-lg:grid-cols-1">
      <div
        ref={mediaRef}
      ...
      <div>
        <SectionHeader kicker={header?.kicker} title={header?.title} titleClassName="mb-14" />
